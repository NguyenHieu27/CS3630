...
class Environment:
    ...
    def diff_drive_kinematics(self, omega_l: float, omega_r: float) -> tuple[float, float]:
        ...
        # Forward speed
        v_x = (radius / 2) * (omega_r + omega_l)
        # Counterclockwise rotational speed
        omega = (radius / self.axle_length) * (omega_r - omega_l)
